...
{
public:
	static PanelSerializer* createInstance(const flatbuffers::WidgetOptions* options){
		return new PanelSerializer(options);
	}
	PanelSerializer(const flatbuffers::WidgetOptions* options)
	{
