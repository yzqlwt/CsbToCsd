...
struct Options : private flatbuffers::Table {
  const WidgetOptions *data() const { return GetPointer<const WidgetOptions *>(4); }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct WidgetOptions : public flatbuffers::Table {
...
struct PointFrameBuilder {
  ...
  void add_position(const Position *position) { fbb_.AddStruct(8, position); }
